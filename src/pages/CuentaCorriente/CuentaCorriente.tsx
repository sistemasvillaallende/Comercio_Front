          ...
          >
            ...
            >
              <Menu className="inline-block mb-2 mr-1">
                ...
                >
                  <Lucide icon="ArrowUpRight" className="w-4 h-4 mr-2" />{" "}
                  Imprimir
                </Button>
                <Menu.Button
                  as={Button}
                ...
                >
                  <Lucide icon="ChevronsDown" className="w-4 h-4 mr-2" />{" "}
                  Informes
                </Menu.Button>
                <Menu.Items className="w-40">
                  <Menu.Item>
                    <Lucide icon="Printer" className="w-4 h-4 mr-2" /> Resumen
                    de cuenta
                  </Menu.Item>
                  <Menu.Item>
                    <Lucide icon="Printer" className="w-4 h-4 mr-2" /> Resumne
                    Cta. Monto Orig.
                  </Menu.Item>
                  <Menu.Item>
                    <Lucide icon="Printer" className="w-4 h-4 mr-2" /> Resumen
                  ...
                  <Menu.Item>
                    <Lucide icon="Printer" className="w-4 h-4 mr-2" /> Informe
                    de Pagos
                  </Menu.Item>
                </Menu.Items>
              </Menu>
              ...
              >
                <Lucide icon="Calculator" className="w-4 h-4 mr-2" /> Simulación
                descuentos
              </Button>
              <Button
                as={Button}
