...
const Editar = () => {
  ...
  const actualizarIyC = (auditoria: String) => {
    ...
    const requestBody = {
      ...
      "per_ult": "2022/12",
      "fecha_inicio": "2022-07-03T00:00:00",
      "fecha_hab": "2023-10-11T14:49:04.2638916-03:00",
      "nro_res": "",
      "nro_exp_mesa_ent": "123372022      ",
      "nro_ing_bruto": "",
      "nro_cuit": "27139302694  ",
      "transporte": false,
      "fecha_alta": fechaActual,
      "nom_calle": "PADRE HUMBERTO MARIANI                  ",
      "nom_barrio": "CENTRO                                  ",
      "ciudad": "VILLA ALLENDE                           ",
      "provincia": "CORDOBA                                 ",
      "pais": "ARGENTINA                               ",
      "cod_postal": "5105",
      "cod_calle_dom_esp": 421,
      "nom_calle_dom_esp": "PADRE HUMBERTO MARIANI",
      "nro_dom_esp": 241,
      "piso_dpto_esp": "",
      "local_esp": "",
      "cod_barrio_dom_esp": 10,
      "nom_barrio_dom_esp": "CENTRO                                  ",
      ...
      "fecha_ddjj_anual": "2023-10-11T14:49:04.2638925-03:00",
      ...
      "cuit_vecino_digital": "",
      "vto_inscripcion": "2022-10-13T09:20:57.237",
      "titular": "",
      "objAuditoria": {
        "id_auditoria": 0,
